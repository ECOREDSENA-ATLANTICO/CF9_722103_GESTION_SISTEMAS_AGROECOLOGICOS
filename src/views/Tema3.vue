  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-4
      ...
      .col-lg-2(data-aos="fade-left")
        figure
            img.d-none.d-md-none.d-lg-block.img-t.m-auto(src='@/assets/curso/tema3/img29.svg', alt='')
    ...
    .row.mb-4
      .col-lg-6.equal(data-aos="fade-right") 
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img
            img.img-t.m-auto(src='@/assets/curso/tema3/img33.svg', alt='')
      ...
      .col-lg-6.equal(data-aos="fade-left") 
        .tarjeta-avatar-b.mb-5.tarjeta-avatar-b-right
          ...
          .tarjeta-avatar-b__img
            img.img-t.m-auto(src='@/assets/curso/tema3/img34.svg', alt='')


      .col-lg-6.equal(data-aos="fade-right") 
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img
            img.img-t.m-auto(src='@/assets/curso/tema3/img35.svg', alt='')
      ...
      .col-lg-6.equal(data-aos="fade-left") 
        .tarjeta-avatar-b.mb-5.tarjeta-avatar-b-right
          ...
          .tarjeta-avatar-b__img
            img.img-t.m-auto(src='@/assets/curso/tema3/img36.svg', alt='')
      ...
      .row.justify-content-center.align-items-top.mb-5
        .col-lg-7(data-aos="fade-right")
          ...
          .mb-3.cajon.o.p-4.ps-5.clr--lightgreen
            .row
              .col-lg-3
                figure
                  img.mb-4.img-t.m-auto(src='@/assets/curso/tema3/img32.svg', alt='')
              .col-lg-9
        ...
        .col-lg-5(data-aos="fade-left")
          figure
            img.img-t.m-auto(src='@/assets/curso/tema3/img31.png', alt='')
      ...
      .row.mb-5.acordion-cf9.grd--white-lightgreen-white
        ...
        figure.d-none.d-lg-block.mb--4
          img.img-t.m-auto(src='@/assets/curso/tema3/img37.svg', alt='')
        figure.d-lg-none.d-md-block
          img.img-t.m-auto(src='@/assets/curso/tema3/img37m.svg', alt='')
    ...
    TabsC.color-acento-contenido.mb-5
      .py-3.py-md-4(titulo="Inmersión")
        .row.align-items-center
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/tema3/img42.png', alt='Texto que describa la imagen')
      .py-3.py-md-4(titulo="Pulverización")
        .row.align-items-center
          .col-md-6.mb-4.mb-md-0
            h4 Pulverización
            p La solución desinfectante se aplica con ayuda de una máquina pulverizadora. El desinfectante actúa en fase líquida y el tamaño medio de gota es mayor a 200μm.

          .col-md-6
            figure
              img(src='@/assets/curso/tema3/img43.png', alt='Texto que describa la imagen')
      ...
      .py-3.py-md-4(titulo="Nebulización")
        .row.align-items-center
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/tema3/img44.png', alt='Texto que describa la imagen')
      ...
      .py-3.py-md-4(titulo="Termo nebulización")
        .row.align-items-center
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/tema3/img45.png', alt='Texto que describa la imagen')
      ...
      .py-3.py-md-4(titulo="ULV (Ultra Low Volumen)")
        .row.align-items-center
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/tema3/img46.png', alt='Texto que describa la imagen')
      ...
      .col-lg-12
        ImagenInfografica.color-secundario.mb-5.d-none.d-lg-block
          template(v-slot:imagen)
            figure
              img.img-t.mx-auto(src='@/assets/curso/tema3/img48.png', alt='Texto que describa la imagen')
