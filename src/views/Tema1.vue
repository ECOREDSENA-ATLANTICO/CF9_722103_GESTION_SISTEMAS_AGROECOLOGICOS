  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 1
      h1(data-aos="fade-right") Poscosecha
    ...
    .titulo-sexto.color-acento-contenido(data-aos="fade-right")
      h5 Figura 1.
      span Clases de pérdidas en poscosecha

    .container.tarjeta.tarjeta--blanca.p-4

      .tarjeta--container.row.mb-5.text-center
        .col-md.tarjeta.p-5.m-2.clr--lightgreen(data-aos="fade-left")
        ...
        .col-md.tarjetas.p-5.m-2.clr-paleYellow(data-aos="fade")
          .row.justify-content-center.mb-4
            .col-10
              figure
        ...
        .col-md.tarjeta.p-5.m-2.clr--lightgreen(data-aos="fade-right")
          .row.justify-content-center.mb-4
            .col-10
              figure
    ...
    .mb-5
      p.text-center
        strong En cuanto a las causas de pérdidas en la poscosecha, se pueden identificar las siguientes:
    ...
    .row.grd--white-lightyellow-white
      .col-lg-10.m-auto
        .titulo-sexto.color-acento-contenido(data-aos="fade-right").mb-4
          h5 Tabla 1.
          span <em>Causas de pérdidas poscosecha</em>

        .tabla-b.color-acento-contenido
          .tabla-b__header
            h4.mb-0 Causas de pérdidas de poscosechas
          table
            tr
              th Fisiológicas
            ...
            tr
              th Biológicos y microbiológicos
              td Hongos, bacterias y microorganismos patógenos que se difunden por el aire, suelo y agua o invadir a través de lesiones por mala manipulación, ataque de insectos, por golpes o grietas de crecimiento.
            tr
              th Culturales y socioeconómicas
              td Generadas principalmente por prácticas tradicionales de manejo, arraigadas entre los agricultores que dificultan la transferencia y adopción de tecnologías.

    separador

    #t_1_1.titulo-segundo.color-acento-contenido(data-aos="zoom-out-right")
        h2 1.1. Manejo poscosecha
          ...
          .row
            ...
            .col-lg-9
              p Según los 
                ...
                span las buenas prácticas de manufactura hacen referencia a los principios básicos y normas de higiene en los diferentes procesos, como son manipulación, preparación, procesamiento, envasado, almacenamiento, transporte y distribución, lo que genera una mejor productividad y obtención de productos inocuos, sanos y de buena calidad.

    p.mb-4 Estas prácticas deben ser aplicadas desde el inicio y durante todo el proceso de poscosecha, debido a que una vez cosechado el producto existen diversos factores que aumentan el riesgo de contaminación, por ejemplo el presentar daños físicos y mecánicos (cortes, lesiones, magulladuras y heridas en general), el ser manipulado por diversas personas, la higiene del personal, la limpieza, desinfección y condiciones de las instalaciones y áreas de procesamiento, los insumos y equipos empleados, etc. Por lo cual, a continuación, se detallan algunas de las recomendaciones que se dan en las BPM para garantizar la higiene.
    ...
    .row.grd--white-lightyellow-white
      .col-lg-12
        ImagenInfografica.color-acento-botones.mb-5.d-none.d-lg-block
          ...
          .tarjeta.p-3.px-4.shadow(x="65.4%" y="9.9%" numero="")
            p.m-0 En el cultivo se deben adecuar sitios protegidos del sol para evitar que los frutos sean trasladados y manipulados de manera excesiva y prolongada. Los cuartos de selección, clasificación y almacenamiento deben poseer condiciones de un buen aseo ventilación y luminosidad.
          
          .tarjeta.p-3.px-4.shadow(x="74.3%" y="55.2%" numero="")
            p.m-0 Muchos de los organismos que son plagas y patógenos en poscosecha y las impurezas (tierra, mugre, residuos de plaguicidas) pueden ser removidos mediante el proceso de limpieza (lavado) y desinfección.

          .tarjeta.p-3.px-4.shadow(x="65.4%" y="86.4%" numero="")
          ...
          .tarjeta.p-3.px-4.shadow(x="33.8%" y="86.4%" numero="")
          ...
          .tarjeta.p-3.px-4.shadow(x="26%" y="55.2%" numero="")
            p.m-0 Los cuartos de almacenamiento, las bandejas de siembra, así como las canastillas en los cuales se transportan y comercializar los productos, se deben desinfectar antes de su utilización.

          
        figure
            img.img-t.m-auto.d-lg-none.d-md-block(src='@/assets/curso/tema1/img211.png', alt='')
